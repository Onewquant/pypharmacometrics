...
prj_dir = f'C:/Users/ilma0/PycharmProjects/pypharmacometrics/Projects/VPA'
resource_dir = f'{prj_dir}/resource'
output_dir = f'C:/Users/ilma0/PycharmProjects/pypharmacometrics/Projects/VPA/results'
if not os.path.exists(output_dir):
    os.mkdir(output_dir)

# 암호 걸린 파일 열기
file_path = f"{resource_dir}/vpa_req_dose_data.xlsx"
password = "snubhsnubh"
...
drugname = 'valproate'
raw_df['DRUG'] = 'valproate'

df = raw_df.copy()
df = df[~df['REGIMEN'].isna()].copy()
...
final_dose_df.to_csv(f"{output_dir}/valproate_dose_df.csv", encoding='utf-8-sig', index=False)
