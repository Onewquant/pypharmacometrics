...
final_df = final_df[['ID', 'TIME', 'DV', 'MDV', 'CMT', 'AMT', 'RATE', 'SEX', 'AGE', 'HT', 'WT', 'BMI',
                     ...
                     'ALP', 'ALB', 'Hct', 'pH', 'RBC', 'ALT', 'ANC', 'Tpro', 'Cr', 'BUN', 'eGFR_CG', 'UA', 'Hb']]

final_df.to_csv('/Users/ssoroomii/Desktop/LSH/03. Paper/01. VCM/CSR2 data/raw data/final_df.csv', index=False)
